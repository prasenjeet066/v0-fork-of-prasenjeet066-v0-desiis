...
const VerificationBadge: React.FC<VerificationBadgeProps> = ({
  ...
  return (
    ...
    <defs>
        <linearGradient id="coolFillGradient" x1="0%" y1="0%" x2="100%" y2="100%">
